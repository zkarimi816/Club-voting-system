...
public class allcandidatescsc implements Initializable{
	 @FXML
		...
		public void initialize(URL arg0, ResourceBundle arg1) {
			 String url = "jdbc:mysql://localhost:3306/vote";
				...
				try { 
					...
					ResultSet rs = mystat.executeQuery("select * from candidates where club = 'Computer Science Club' and gpa >= 3.0");				
					while(rs.next()) {
